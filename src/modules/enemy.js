import imageEnemy1 from '../img/enemy_1.png'
import imageEnemy2 from '../img/enemy_2.png'
import {cosBetweenTwoPoints, sinBetweenTwoPoints} from './utilities';
...
export class Enemy {
  ...
  constructor(canvasWidth, canvasHeight, context, player) {
    ...
    this.image.src = (enemyType === 1) ? imageEnemy1 : imageEnemy2;
    this.imageWidth = 50;
    this.imageHeight = 60;
    this.imageTick = 0;
  }
